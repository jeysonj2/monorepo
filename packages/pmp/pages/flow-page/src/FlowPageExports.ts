...
// types & interfaces
import type { UserModel, ChangeEvent as PageTemplateChange } from '@interzero-pmp/page-template';
...
export class FlowPage extends LitElement {
  ...
  private handlePageTemplateChange = (event:CustomEvent<PageTemplateChange>) => {
    this.dispatchEvent(new CustomEvent<PageTemplateChange>("viewport-change", event));
  }
